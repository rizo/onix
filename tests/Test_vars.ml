...
let build_context =
  Onix.Build_context.read_json (Yojson.Basic.from_string input)
...
let check_vars () =
  ...
  check_var "options:stublibs"
    "/nix/store/qvnnk93pgl184021bbysp7036rzx30rh-options-dev/lib/ocaml/4.14.0/site-lib/stublibs";
  check_var "options:toplevel"
    "/nix/store/qvnnk93pgl184021bbysp7036rzx30rh-options-dev/lib/ocaml/4.14.0/site-lib/toplevel";
  ...
  check_var "bos:stublibs"
    "/nix/store/xfmk9f2ykalizkgfg620gbya67fa09si-bos-0.2.1/lib/ocaml/4.14.0/site-lib/stublibs";
  check_var "bos:toplevel"
    "/nix/store/xfmk9f2ykalizkgfg620gbya67fa09si-bos-0.2.1/lib/ocaml/4.14.0/site-lib/toplevel";
  check_var "bos:man"
