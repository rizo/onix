...
rec {
  ...
  "astring" = {
    ...
    depends = [ "ocaml" ];
    buildDepends = [ "ocamlbuild" "ocamlfind" "topkg" ];
  };
  "base-bigarray" = {
    name = "base-bigarray";
    version = "base";
  ...
  "ocaml-system" = {
    ...
    depexts = [ "ocaml-ng.ocamlPackages_4_14.ocaml" ];
    flags = ["compiler" ];
  };
  "ocamlbuild" = {
    name = "ocamlbuild";
  ...
  "onix" = {
    ...
    depends = [ "bos" "cmdliner" "easy-format" "fmt" "fpath" "logs" "ocaml"
  ...
  "opam-0install" = {
    ...
    depends = [ "0install-solver" "cmdliner" "dune" "fmt" "ocaml"
  ...
  "topkg" = {
    ...
    buildDepends = [ "ocamlbuild" "ocamlfind" ];
  };
  "yojson" = {
    name = "yojson";
    version = "2.0.2";
